...
def _require_streamlit_runtime() -> None:
    ...
    if context is None:
        raise SystemExit(
            "FEHLER: Die Netzentgelt-Anwendung ist eine Streamlit-App und darf nicht direkt mit Python gestartet werden.\n"
            "Starte im Projektordner: .\\RUN_TOOL.bat\n"
            "Alternativ: .venv\\Scripts\\python.exe -m streamlit run app\\secure_app.py"
        )
