"""CSV scoping helper for generated Netzentgelt UI exports."""
...
from role_scope_registry_module import ScopeRegistry, build_scope_registry, filter_dataframe_with_registry
...
def build_scoped_csv_reader(
    ...
    def registry() -> ScopeRegistry | None:
        ...
        if not TIMELINE_PATH.exists():
            return None
        timeline = original_reader(TIMELINE_PATH, sep=None, engine="python", encoding="utf-8-sig")
