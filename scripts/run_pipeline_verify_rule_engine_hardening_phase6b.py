...
def main() -> int:
    ...
    backup = BACKUP_ROOT / f"rule_engine_hardening_phase6b_runtime_{stamp}"
    ...
    try:
        ...
        run([sys.executable, str(ROOT / "scripts" / "verify_rule_engine_hardening_phase6b.py")])
    except Exception:
    ...
    print("OK: Pipeline und Phase-6B-Verifikation erfolgreich.")
    return 0
