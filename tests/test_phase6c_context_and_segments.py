...
def test_gap_context_classification_and_cold_stand_candidate(con):
    ...
    first = movement(
        ...
        next_origin_name="Hamburg",
        next_origin_country_iso="DE",
    )
    second = movement(
        2,
...
def test_central_de_segments_use_border_bounded_times(con):
    ...
    entry = movement(
        ...
        actual_arrival_ts=datetime(2026, 6, 1, 9, 30),
        period_start_utc=datetime(2026, 6, 1, 8),
        period_end_utc=datetime(2026, 6, 1, 9, 30),
    ...
    exit_row = movement(
        ...
        faulty_dir="A",
        actual_departure_ts=datetime(2026, 6, 1, 9, 30),
        actual_arrival_ts=datetime(2026, 6, 1, 11),
        period_start_utc=datetime(2026, 6, 1, 9, 30),
