...
if not exist config\portable_runtime.enc (
  ...
  echo Erzeuge sie zuerst mit: python tools\write_portable_config.py --input config\portable_runtime.private.json
  exit /b 3
)
...
pyinstaller --clean --noconfirm build\NetzentgeltTool.spec
